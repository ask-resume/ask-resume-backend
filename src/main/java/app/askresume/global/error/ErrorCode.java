...
public enum ErrorCode {
     ...
     * 시스템 에러
     */
    THREAD_MALFUNCTION(HttpStatus.INTERNAL_SERVER_ERROR, "SYS-001", "thread.malfunction"),
    JSON_PARSING_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "SYS-002", "json.parsing.failed"),
    OMITTING_REQUIRED_VALUES(HttpStatus.INTERNAL_SERVER_ERROR, "SYS-003", "omitting.required.values");
